for path in [r"C:\Users\ASRAR BASHA\.gemini\antigravity\scratch\ggwins\index.html", r"C:\Users\ASRAR BASHA\.gemini\antigravity\brain\adfb82a4-49a4-4622-8f3c-72850acc0c06\index.html"]:
    with open(path, "r", encoding="utf-8") as f:
        c = f.read()
    import re
    # Remove all hero-carousel sections
    c = re.sub(r'<section class="hero-carousel".*?</section>', '', c, flags=re.DOTALL)
    # Remove css rules for hero-carousel
    c = re.sub(r'/\* ── AUTO-ROTATING HERO SLIDER ── \*/.*?(?=/\* ── FULL PAGE QUICK LAUNCH)', '', c, flags=re.DOTALL)
